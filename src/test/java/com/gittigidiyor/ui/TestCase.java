...
public class TestCase extends BaseTest {
    ...
    public void gittiGidiyorTest() throws InterruptedException {
        ...
        Assert.assertTrue(accountButtonText.contains("Hesabım"));
        ...
        Assert.assertTrue(webDriver.getCurrentUrl().contains("2"));
        ...
        Thread.sleep(2000);
        Assert.assertTrue(cartPage.getTotalProduct().contains("2 Adet"));
        ...
        Assert.assertEquals(sepetMesaj, cartPage.isEmpty());
        webDriver.quit();
    }
}